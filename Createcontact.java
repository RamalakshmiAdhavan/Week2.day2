...
//		 * 11. Enter Department Field Using any Locator of Your Choice
		driver.findElement(By.id("createContactForm_departmentName")).sendKeys("MBA HR");

//		 * 
//		 * 12. Enter Description Field Using any Locator of your choice 
		driver.findElement(By.id("createContactForm_description")).sendKeys("Learning Automation");
...
//		 * 14. Select State/Province as NewYork Using Visible Text
		...
		Select states_Dropdown = new Select(state);
